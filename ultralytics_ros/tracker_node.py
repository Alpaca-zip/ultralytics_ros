...
class TrackerNode(Node):
    def __init__(self):
        ...
        self.debug_conf = self.get_parameter("debug_conf").get_parameter_value().bool_value
        self.debug_line_width = self.get_parameter("debug_line_width").get_parameter_value().integer_value
        self.debug_font_size = self.get_parameter("debug_font_size").get_parameter_value().integer_value
        self.debug_font = self.get_parameter("debug_font").get_parameter_value().string_value
        self.debug_labels = self.get_parameter("debug_labels").get_parameter_value().bool_value
        self.debug_boxes = self.get_parameter("debug_boxes").get_parameter_value().bool_value
        ...
        self.timer_detection = self.create_timer(1.0 / publish_rate, self.publish_detection)
        self.header = None
        self.results = None
